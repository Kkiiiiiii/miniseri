<div class="container py-5 text-center">
    ...
    <h3 class="fw-bold mb-3">Trending Minggu Ini</h3>
    ...
    <div class="row g-4">
        @foreach ($gambar as $g)
              <div class="col-md-4">
                <div class="glass-card h-100 rounded-4 overflow-hidden transition">
                    ...
                    <div class="p-4 text-start">
                        <h4 class="h6 fw-bold text-magenta-gradient fw-bold mb-1 small">
                            {{ $g->judul }}
                        </h4>

                        <p class="text-white m-0 small cursor"
